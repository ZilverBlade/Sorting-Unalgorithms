set(SH_SRC "${CMAKE_SOURCE_DIR}/src/permute_sort")
file(GLOB_RECURSE ENDF6_SRC
      "${SH_SRC}/*.h"
      "${SH_SRC}/*.cpp")
      
add_executable("permute_sort" ${ENDF6_SRC})
...
set_target_properties("permute_sort" PROPERTIES
  CXX_STANDARD 17
